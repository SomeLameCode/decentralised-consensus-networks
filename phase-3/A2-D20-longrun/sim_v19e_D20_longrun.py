"""
sim_v19e_D20_longrun.py -- Phase 3 Series A2: D=20 run (Run 59)

Context: D=10 produced a highly unexpected result -- T2 and T3 converge at
t=177 and t=109 respectively (60-80x faster than D=5 for those topics).
D=20 tests whether the non-monotone speed-up continues at higher D.

Fixed: N=30, M=3, D=20, T=100000, ALPHA=0.3, ETA=0.15, LAMBDA=0.1, KAPPA=0.0
       Gaussian init, WS k=4 p=0.1, seed=42

Outputs (workspace/simulation/phase-3/):
  sim_v19e_D20_longrun_plots.png
  D20-longrun-summary.csv

Run from project root:
  python workspace/simulation/phase-3/sim_v19e_D20_longrun.py
"""
...
print("=" * 72)
print(f"sim_v19e_D20_longrun.py -- D=20 (Run 59) | seed={SEED} | T={T}")
...
csv_path = os.path.join(OUTPUT_DIR, "D20-longrun-summary.csv")
...
fig.suptitle(
    f"sim_v19e_D20_longrun.py -- D=20 (Run 59) | seed={SEED} | T={T}\n"
...
plt.tight_layout()
plot_path = os.path.join(OUTPUT_DIR, "sim_v19e_D20_longrun_plots.png")
plt.savefig(plot_path, dpi=150, bbox_inches="tight")
print(f"Plots saved -> {plot_path}")
print(f"\n-- sim_v19e_D20_longrun.py complete --")
